// src/database/migrations/1710522000000-AddMissingColumnsToWatchHistory.ts
import { MigrationInterface, QueryRunner } from 'typeorm';

export class AddMissingColumnsToWatchHistory1710522000000 implements MigrationInterface {
